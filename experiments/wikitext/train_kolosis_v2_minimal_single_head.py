"""
WikiText-103 Training: Kolosis V2 Minimal (Single Head)
...
def main():
    print("="*60)
    print("WIKITEXT-103: KOLOSIS V2 MINIMAL (SINGLE HEAD)")
    print("="*60)
    ...
    print(f"\nCreating Kolosis V2 Minimal (Single Head)...")
    ...
    for epoch in range(config['epochs']):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), 'experiments/wikitext_results/kolosis_v2_minimal_single_head_best.pt')
            print("  ✅ Saved best model")
    
    with open('experiments/wikitext_results/kolosis_v2_minimal_single_head_results.json', 'w') as f:
